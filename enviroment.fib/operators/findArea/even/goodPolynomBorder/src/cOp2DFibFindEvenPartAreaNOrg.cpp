/**
 * @file cOp2DFibFindEvenPartAreaNOrg
 * file name: cOp2DFibFindEvenPartAreaNOrg.h
...
#include "cOp2DFibFindEvenPartAreaNOrg.h"
 ...
 */
cOp2DFibFindEvenPartAreaNOrg::cOp2DFibFindEvenPartAreaNOrg( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenPartAreaNOrg.
 */
cOp2DFibFindEvenPartAreaNOrg::~cOp2DFibFindEvenPartAreaNOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenPartAreaNOrg * cOp2DFibFindEvenPartAreaNOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenPartAreaNOrg( operationId );
}
 ...
 */
bool cOp2DFibFindEvenPartAreaNOrg::run(){
 ...
 */
string cOp2DFibFindEvenPartAreaNOrg::getName() const{
	return "cOp2DFibFindEvenPartAreaNOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenPartAreaNOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenPartAreaNOrg::isNull( const double & dValue ){
