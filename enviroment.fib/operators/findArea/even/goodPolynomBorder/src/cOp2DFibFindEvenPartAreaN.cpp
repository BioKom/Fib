/**
 * @file cOp2DFibFindEvenPartAreaN
 * file name: cOp2DFibFindEvenPartAreaN.h
...
#include "cOp2DFibFindEvenPartAreaN.h"
 ...
 */
cOp2DFibFindEvenPartAreaN::cOp2DFibFindEvenPartAreaN( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenPartAreaN.
 */
cOp2DFibFindEvenPartAreaN::~cOp2DFibFindEvenPartAreaN(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenPartAreaN * cOp2DFibFindEvenPartAreaN::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenPartAreaN( operationId );
}
 ...
 */
bool cOp2DFibFindEvenPartAreaN::run(){
 ...
 */
string cOp2DFibFindEvenPartAreaN::getName() const{
	return "cOp2DFibFindEvenPartAreaN";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenPartAreaN::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenPartAreaN::isNull( const double & dValue ){
