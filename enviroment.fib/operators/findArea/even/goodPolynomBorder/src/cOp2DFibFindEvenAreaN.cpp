/**
 * @file cOp2DFibFindEvenAreaN
 * file name: cOp2DFibFindEvenAreaN.h
...
#include "cOp2DFibFindEvenAreaN.h"
 ...
 */
cOp2DFibFindEvenAreaN::cOp2DFibFindEvenAreaN( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenAreaN.
 */
cOp2DFibFindEvenAreaN::~cOp2DFibFindEvenAreaN(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenAreaN * cOp2DFibFindEvenAreaN::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenAreaN( operationId );
}
 ...
 */
bool cOp2DFibFindEvenAreaN::run(){
 ...
 */
string cOp2DFibFindEvenAreaN::getName() const{
	return "cOp2DFibFindEvenAreaN";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenAreaN::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenAreaN::isNull( const double & dValue ){
