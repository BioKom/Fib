/**
 * @file cOp2DFibFindEvenPartArea
 * file name: cOp2DFibFindEvenPartArea.h
...
#include "cOp2DFibFindEvenPartArea.h"
 ...
 */
cOp2DFibFindEvenPartArea::cOp2DFibFindEvenPartArea( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenPartArea.
 */
cOp2DFibFindEvenPartArea::~cOp2DFibFindEvenPartArea(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenPartArea * cOp2DFibFindEvenPartArea::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenPartArea( operationId );
}
 ...
 */
bool cOp2DFibFindEvenPartArea::run(){
 ...
 */
string cOp2DFibFindEvenPartArea::getName() const{
	return "cOp2DFibFindEvenPartArea";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenPartArea::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenPartArea::isNull( const double & dValue ){
