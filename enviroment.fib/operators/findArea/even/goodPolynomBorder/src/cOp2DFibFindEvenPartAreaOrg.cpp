/**
 * @file cOp2DFibFindEvenPartAreaOrg
 * file name: cOp2DFibFindEvenPartAreaOrg.h
...
#include "cOp2DFibFindEvenPartAreaOrg.h"
 ...
 */
cOp2DFibFindEvenPartAreaOrg::cOp2DFibFindEvenPartAreaOrg( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenPartAreaOrg.
 */
cOp2DFibFindEvenPartAreaOrg::~cOp2DFibFindEvenPartAreaOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenPartAreaOrg * cOp2DFibFindEvenPartAreaOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenPartAreaOrg( operationId );
}
 ...
 */
bool cOp2DFibFindEvenPartAreaOrg::run(){
 ...
 */
string cOp2DFibFindEvenPartAreaOrg::getName() const{
	return "cOp2DFibFindEvenPartAreaOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenPartAreaOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenPartAreaOrg::isNull( const double & dValue ){
