/**
 * @file cOp2DFibFindEvenAreaNOrg
 * file name: cOp2DFibFindEvenAreaNOrg.h
...
#include "cOp2DFibFindEvenAreaNOrg.h"
 ...
 */
cOp2DFibFindEvenAreaNOrg::cOp2DFibFindEvenAreaNOrg( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenAreaNOrg.
 */
cOp2DFibFindEvenAreaNOrg::~cOp2DFibFindEvenAreaNOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenAreaNOrg * cOp2DFibFindEvenAreaNOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenAreaNOrg( operationId );
}
 ...
 */
bool cOp2DFibFindEvenAreaNOrg::run(){
 ...
 */
string cOp2DFibFindEvenAreaNOrg::getName() const{
	return "cOp2DFibFindEvenAreaNOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenAreaNOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenAreaNOrg::isNull( const double & dValue ){
