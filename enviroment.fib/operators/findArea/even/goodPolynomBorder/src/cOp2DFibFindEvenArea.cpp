/**
 * @file cOp2DFibFindEvenArea
 * file name: cOp2DFibFindEvenArea.h
...
#include "cOp2DFibFindEvenArea.h"
 ...
 */
cOp2DFibFindEvenArea::cOp2DFibFindEvenArea( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenArea.
 */
cOp2DFibFindEvenArea::~cOp2DFibFindEvenArea(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenArea * cOp2DFibFindEvenArea::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenArea( operationId );
}
 ...
 */
string cOp2DFibFindEvenArea::getName() const{
	return "cOp2DFibFindEvenArea";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenArea::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenArea::isNull( const double & dValue ){
