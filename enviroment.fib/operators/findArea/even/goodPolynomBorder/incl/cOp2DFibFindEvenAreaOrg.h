...
#ifndef ___C_OP_2D_FIB_FIND_EVEN_AREA_ORG_H__
#define ___C_OP_2D_FIB_FIND_EVEN_AREA_ORG_H__
...
class cOp2DFibFindEvenAreaOrg: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindEvenAreaOrg( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindEvenAreaOrg.
	 */
	virtual ~cOp2DFibFindEvenAreaOrg();
	 ...
	 */
	virtual cOp2DFibFindEvenAreaOrg * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindEvenAreaOrg


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_EVEN_AREA_ORG_H__
