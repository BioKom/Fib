...
#ifndef ___C_OP_2D_FIB_FIND_EVEN_AREA_H__
#define ___C_OP_2D_FIB_FIND_EVEN_AREA_H__
...
class cOp2DFibFindEvenArea: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindEvenArea( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindEvenArea.
	 */
	virtual ~cOp2DFibFindEvenArea();
	 ...
	 */
	virtual cOp2DFibFindEvenArea * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindEvenArea


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_EVEN_AREA_H__
