...
#ifndef ___C_OP_2D_FIB_FIND_EVEN_PART_AREA_ORG_H__
#define ___C_OP_2D_FIB_FIND_EVEN_PART_AREA_ORG_H__
...
class cOp2DFibFindEvenPartAreaOrg: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindEvenPartAreaOrg( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindEvenPartAreaOrg.
	 */
	virtual ~cOp2DFibFindEvenPartAreaOrg();
	 ...
	 */
	virtual cOp2DFibFindEvenPartAreaOrg * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindEvenPartAreaOrg


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_EVEN_PART_AREA_ORG_H__
