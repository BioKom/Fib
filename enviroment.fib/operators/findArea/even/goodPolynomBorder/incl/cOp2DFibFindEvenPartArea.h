...
#ifndef ___C_OP_2D_FIB_FIND_EVEN_PART_AREA_H__
#define ___C_OP_2D_FIB_FIND_EVEN_PART_AREA_H__
...
class cOp2DFibFindEvenPartArea: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindEvenPartArea( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindEvenPartArea.
	 */
	virtual ~cOp2DFibFindEvenPartArea();
	 ...
	 */
	virtual cOp2DFibFindEvenPartArea * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindEvenPartArea


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_EVEN_PART_AREA_H__
