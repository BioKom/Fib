...
#ifndef ___C_OP_2D_FIB_FIND_EVEN_PART_AREA_N_ORG_H__
#define ___C_OP_2D_FIB_FIND_EVEN_PART_AREA_N_ORG_H__
...
class cOp2DFibFindEvenPartAreaNOrg: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindEvenPartAreaNOrg( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindEvenPartAreaNOrg.
	 */
	virtual ~cOp2DFibFindEvenPartAreaNOrg();
	 ...
	 */
	virtual cOp2DFibFindEvenPartAreaNOrg * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindEvenPartAreaNOrg


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_EVEN_PART_AREA_N_ORG_H__
