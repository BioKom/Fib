...
#ifndef ___C_OP_2D_FIB_FIND_EVEN_AREA_N_ORG_H__
#define ___C_OP_2D_FIB_FIND_EVEN_AREA_N_ORG_H__
...
class cOp2DFibFindEvenAreaNOrg: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindEvenAreaNOrg( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindEvenAreaNOrg.
	 */
	virtual ~cOp2DFibFindEvenAreaNOrg();
	 ...
	 */
	virtual cOp2DFibFindEvenAreaNOrg * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindEvenAreaNOrg


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_EVEN_AREA_N_ORG_H__
