...
#ifndef ___C_OP_2D_FIB_FIND_EVEN_AREA_N_H__
#define ___C_OP_2D_FIB_FIND_EVEN_AREA_N_H__
...
class cOp2DFibFindEvenAreaN: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindEvenAreaN( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindEvenAreaN.
	 */
	virtual ~cOp2DFibFindEvenAreaN();
	 ...
	 */
	virtual cOp2DFibFindEvenAreaN * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindEvenAreaN


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_EVEN_AREA_N_H__
