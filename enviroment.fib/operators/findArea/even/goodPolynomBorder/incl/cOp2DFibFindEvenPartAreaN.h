...
#ifndef ___C_OP_2D_FIB_FIND_EVEN_PART_AREA_N_H__
#define ___C_OP_2D_FIB_FIND_EVEN_PART_AREA_N_H__
...
class cOp2DFibFindEvenPartAreaN: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindEvenPartAreaN( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindEvenPartAreaN.
	 */
	virtual ~cOp2DFibFindEvenPartAreaN();
	 ...
	 */
	virtual cOp2DFibFindEvenPartAreaN * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindEvenPartAreaN


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_EVEN_PART_AREA_N_H__
