...
#ifndef ___C_OP_2D_FIB_FIND_EVEN_PART_AREA_SPLINE_MAX_4_BORDER_ITR_FAST_ORG_H__
#define ___C_OP_2D_FIB_FIND_EVEN_PART_AREA_SPLINE_MAX_4_BORDER_ITR_FAST_ORG_H__
...
class cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg.
	 */
	virtual ~cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg();
	 ...
	 */
	virtual cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_EVEN_PART_AREA_SPLINE_MAX_4_BORDER_ITR_FAST_ORG_H__
