/**
 * @file cOp2DFibFindEvenAreaNSplineMax4BorderItrFast
 * file name: cOp2DFibFindEvenAreaNSplineMax4BorderItrFast.h
...
#include "cOp2DFibFindEvenAreaNSplineMax4BorderItrFast.h"
 ...
 */
cOp2DFibFindEvenAreaNSplineMax4BorderItrFast::cOp2DFibFindEvenAreaNSplineMax4BorderItrFast( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenAreaNSplineMax4BorderItrFast.
 */
cOp2DFibFindEvenAreaNSplineMax4BorderItrFast::~cOp2DFibFindEvenAreaNSplineMax4BorderItrFast(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenAreaNSplineMax4BorderItrFast * cOp2DFibFindEvenAreaNSplineMax4BorderItrFast::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenAreaNSplineMax4BorderItrFast( operationId );
}
 ...
 */
bool cOp2DFibFindEvenAreaNSplineMax4BorderItrFast::run(){
	...
	for ( unsignedLongFib ulActualArea = 1; ulActualArea <= ulAreasToCreate;
		...
		if ( pAreaFibObject == NULL ){
			DEBUG_OUT_EL2(<<"Error: createSplineItrFastBorderAreasForPoints() returned NULL"<<endl<<flush);
 ...
 */
string cOp2DFibFindEvenAreaNSplineMax4BorderItrFast::getName() const{
	return "cOp2DFibFindEvenAreaNSplineMax4BorderItrFast";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenAreaNSplineMax4BorderItrFast::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenAreaNSplineMax4BorderItrFast::isNull( const double & dValue ){
