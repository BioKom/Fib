/**
 * @file cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg
 * file name: cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg.h
...
#include "cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg.h"
 ...
 */
cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg::cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg.
 */
cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg::~cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg * cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg( operationId );
}
 ...
 */
bool cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg::run(){
 ...
 */
string cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg::getName() const{
	return "cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFastOrg::isNull( const double & dValue ){
