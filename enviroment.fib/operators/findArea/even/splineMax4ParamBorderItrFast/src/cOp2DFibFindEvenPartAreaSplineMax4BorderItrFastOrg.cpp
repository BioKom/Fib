/**
 * @file cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg
 * file name: cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg.h
...
#include "cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg.h"
 ...
 */
cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg::cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg.
 */
cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg::~cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg * cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg( operationId );
}
 ...
 */
bool cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg::run(){
 ...
 */
string cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg::getName() const{
	return "cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenPartAreaSplineMax4BorderItrFastOrg::isNull( const double & dValue ){
