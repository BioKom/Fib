/**
 * @file cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg
 * file name: cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg.h
...
#include "cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg.h"
 ...
 */
cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg::cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg.
 */
cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg::~cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg * cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg( operationId );
}
 ...
 */
bool cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg::run(){
 ...
 */
string cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg::getName() const{
	return "cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenAreaSplineMax4BorderItrFastOrg::isNull( const double & dValue ){
