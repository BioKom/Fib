/**
 * @file cOp2DFibFindEvenAreaSplineMax4BorderItrFast
 * file name: cOp2DFibFindEvenAreaSplineMax4BorderItrFast.h
...
#include "cOp2DFibFindEvenAreaSplineMax4BorderItrFast.h"
 ...
 */
cOp2DFibFindEvenAreaSplineMax4BorderItrFast::cOp2DFibFindEvenAreaSplineMax4BorderItrFast( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenAreaSplineMax4BorderItrFast.
 */
cOp2DFibFindEvenAreaSplineMax4BorderItrFast::~cOp2DFibFindEvenAreaSplineMax4BorderItrFast(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenAreaSplineMax4BorderItrFast * cOp2DFibFindEvenAreaSplineMax4BorderItrFast::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenAreaSplineMax4BorderItrFast( operationId );
}
 ...
 */
bool cOp2DFibFindEvenAreaSplineMax4BorderItrFast::run(){
 ...
 */
string cOp2DFibFindEvenAreaSplineMax4BorderItrFast::getName() const{
	return "cOp2DFibFindEvenAreaSplineMax4BorderItrFast";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenAreaSplineMax4BorderItrFast::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenAreaSplineMax4BorderItrFast::isNull( const double & dValue ){
