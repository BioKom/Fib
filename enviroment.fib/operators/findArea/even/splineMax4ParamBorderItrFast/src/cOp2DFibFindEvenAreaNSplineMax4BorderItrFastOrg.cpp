/**
 * @file cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg
 * file name: cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg.h
...
#include "cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg.h"
 ...
 */
cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg::cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg.
 */
cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg::~cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg * cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg( operationId );
}
 ...
 */
bool cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg::run(){
 ...
 */
string cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg::getName() const{
	return "cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenAreaNSplineMax4BorderItrFastOrg::isNull( const double & dValue ){
