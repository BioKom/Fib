/**
 * @file cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast
 * file name: cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast.h
 ...
 *
 *
 * Evalues the areas with the same properties and combines n random to
...
#include "cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast.h"
 ...
 */
cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast::cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast.
 */
cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast::~cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast * cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast( operationId );
}
 ...
 */
bool cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast::run(){
	...
	const unsignedLongFib ulNumberOfPoints = evaluedPositionsData.liEvaluedPositionData.size();
		...
		while ( ! setPointsToCheck.empty() ){
			...
			for ( unsigned int uiNeibour = 0; uiNeibour < 4; uiNeibour++ ){
				...
				if ( ( setCheckedPoints.find( actualPosition ) == setCheckedPoints.end() ) &&
					...
					//compare the properties of the points with the properties of the original point
					if ( liChoosenProperties == (*(itrActualPoint->second)) ){
 ...
 */
string cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast::getName() const{
	return "cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenPartAreaNSplineMax4BorderItrFast::isNull( const double & dValue ){
