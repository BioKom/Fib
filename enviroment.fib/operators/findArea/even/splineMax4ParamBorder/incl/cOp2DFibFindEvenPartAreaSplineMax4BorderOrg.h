/**
 * @file cOp2DFibFindEvenPartAreaSplineMax4BorderOrg
 * file name: cOp2DFibFindEvenPartAreaSplineMax4BorderOrg.h
...
#ifndef ___C_OP_2D_FIB_FIND_EVEN_PART_AREA_SPLINE_MAX_4_BORDER_ORG_H__
#define ___C_OP_2D_FIB_FIND_EVEN_PART_AREA_SPLINE_MAX_4_BORDER_ORG_H__
...
class cOp2DFibFindEvenPartAreaSplineMax4BorderOrg: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindEvenPartAreaSplineMax4BorderOrg( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindEvenPartAreaSplineMax4BorderOrg.
	 */
	virtual ~cOp2DFibFindEvenPartAreaSplineMax4BorderOrg();
	 ...
	 */
	virtual cOp2DFibFindEvenPartAreaSplineMax4BorderOrg * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindEvenPartAreaSplineMax4BorderOrg


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_EVEN_PART_AREA_SPLINE_MAX_4_BORDER_ORG_H__
