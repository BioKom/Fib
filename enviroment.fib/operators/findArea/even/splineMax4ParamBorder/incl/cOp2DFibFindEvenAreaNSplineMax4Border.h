...
#ifndef ___C_OP_2D_FIB_FIND_EVEN_AREA_N_SPLINE_MAX_4_BORDER_H__
#define ___C_OP_2D_FIB_FIND_EVEN_AREA_N_SPLINE_MAX_4_BORDER_H__
...
class cOp2DFibFindEvenAreaNSplineMax4Border: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindEvenAreaNSplineMax4Border( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindEvenAreaNSplineMax4Border.
	 */
	virtual ~cOp2DFibFindEvenAreaNSplineMax4Border();
	 ...
	 */
	virtual cOp2DFibFindEvenAreaNSplineMax4Border * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindEvenAreaNSplineMax4Border


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_EVEN_AREA_N_SPLINE_MAX_4_BORDER_H__
