...
#ifndef ___C_OP_2D_FIB_FIND_EVEN_AREA_SPLINE_MAX_4_BORDER_H__
#define ___C_OP_2D_FIB_FIND_EVEN_AREA_SPLINE_MAX_4_BORDER_H__
...
class cOp2DFibFindEvenAreaSplineMax4Border: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindEvenAreaSplineMax4Border( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindEvenAreaSplineMax4Border.
	 */
	virtual ~cOp2DFibFindEvenAreaSplineMax4Border();
	 ...
	 */
	virtual cOp2DFibFindEvenAreaSplineMax4Border * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindEvenAreaSplineMax4Border


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_EVEN_AREA_SPLINE_MAX_4_BORDER_H__
