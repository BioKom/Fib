...
#ifndef ___C_OP_2D_FIB_FIND_EVEN_AREA_SPLINE_MAX_4_BORDER_ORG_H__
#define ___C_OP_2D_FIB_FIND_EVEN_AREA_SPLINE_MAX_4_BORDER_ORG_H__
...
class cOp2DFibFindEvenAreaSplineMax4BorderOrg: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindEvenAreaSplineMax4BorderOrg( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindEvenAreaSplineMax4BorderOrg.
	 */
	virtual ~cOp2DFibFindEvenAreaSplineMax4BorderOrg();
	 ...
	 */
	virtual cOp2DFibFindEvenAreaSplineMax4BorderOrg * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindEvenAreaSplineMax4BorderOrg


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_EVEN_AREA_SPLINE_MAX_4_BORDER_ORG_H__
