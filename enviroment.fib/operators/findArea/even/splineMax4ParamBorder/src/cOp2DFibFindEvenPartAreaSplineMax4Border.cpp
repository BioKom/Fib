/**
 * @file cOp2DFibFindEvenPartAreaSplineMax4Border
 * file name: cOp2DFibFindEvenPartAreaSplineMax4Border.h
...
#include "cOp2DFibFindEvenPartAreaSplineMax4Border.h"
 ...
 */
cOp2DFibFindEvenPartAreaSplineMax4Border::cOp2DFibFindEvenPartAreaSplineMax4Border( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenPartAreaSplineMax4Border.
 */
cOp2DFibFindEvenPartAreaSplineMax4Border::~cOp2DFibFindEvenPartAreaSplineMax4Border(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenPartAreaSplineMax4Border * cOp2DFibFindEvenPartAreaSplineMax4Border::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenPartAreaSplineMax4Border( operationId );
}
 ...
 */
bool cOp2DFibFindEvenPartAreaSplineMax4Border::run(){
	...
	cDomainSingle * pDirectionDomain =
	...
	pDirectionDomain = pVecDomainDimension->getElementDomain( 2 );
...
//#define DEBUG_OUTPUT_MATRIX
	...
	DEBUG_OUT_L2(<<"createSplineBorderAreasForPoints()"<<endl<<flush);
	cFibElement * pAreaFibObject = createSplineBorderAreasForPoints< longFib >(
 ...
 */
string cOp2DFibFindEvenPartAreaSplineMax4Border::getName() const{
	return "cOp2DFibFindEvenPartAreaSplineMax4Border";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenPartAreaSplineMax4Border::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenPartAreaSplineMax4Border::isNull( const double & dValue ){
