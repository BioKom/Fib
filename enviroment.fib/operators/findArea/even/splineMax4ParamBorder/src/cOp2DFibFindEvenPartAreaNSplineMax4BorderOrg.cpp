/**
 * @file cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg
 * file name: cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg.h
...
#include "cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg.h"
 ...
 */
cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg::cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg.
 */
cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg::~cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg * cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg( operationId );
}
 ...
 */
bool cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg::run(){
 ...
 */
string cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg::getName() const{
	return "cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenPartAreaNSplineMax4BorderOrg::isNull( const double & dValue ){
