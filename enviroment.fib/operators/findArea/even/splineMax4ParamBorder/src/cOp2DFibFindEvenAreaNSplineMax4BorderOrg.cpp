/**
 * @file cOp2DFibFindEvenAreaNSplineMax4BorderOrg
 * file name: cOp2DFibFindEvenAreaNSplineMax4BorderOrg.h
...
#include "cOp2DFibFindEvenAreaNSplineMax4BorderOrg.h"
 ...
 */
cOp2DFibFindEvenAreaNSplineMax4BorderOrg::cOp2DFibFindEvenAreaNSplineMax4BorderOrg( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenAreaNSplineMax4BorderOrg.
 */
cOp2DFibFindEvenAreaNSplineMax4BorderOrg::~cOp2DFibFindEvenAreaNSplineMax4BorderOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenAreaNSplineMax4BorderOrg * cOp2DFibFindEvenAreaNSplineMax4BorderOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenAreaNSplineMax4BorderOrg( operationId );
}
 ...
 */
bool cOp2DFibFindEvenAreaNSplineMax4BorderOrg::run(){
 ...
 */
string cOp2DFibFindEvenAreaNSplineMax4BorderOrg::getName() const{
	return "cOp2DFibFindEvenAreaNSplineMax4BorderOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenAreaNSplineMax4BorderOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenAreaNSplineMax4BorderOrg::isNull( const double & dValue ){
