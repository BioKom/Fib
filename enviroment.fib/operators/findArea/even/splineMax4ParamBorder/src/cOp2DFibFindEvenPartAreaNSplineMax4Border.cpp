/**
 * @file cOp2DFibFindEvenPartAreaNSplineMax4Border
 * file name: cOp2DFibFindEvenPartAreaNSplineMax4Border.h
...
#include "cOp2DFibFindEvenPartAreaNSplineMax4Border.h"
 ...
 */
cOp2DFibFindEvenPartAreaNSplineMax4Border::cOp2DFibFindEvenPartAreaNSplineMax4Border( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenPartAreaNSplineMax4Border.
 */
cOp2DFibFindEvenPartAreaNSplineMax4Border::~cOp2DFibFindEvenPartAreaNSplineMax4Border(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenPartAreaNSplineMax4Border * cOp2DFibFindEvenPartAreaNSplineMax4Border::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenPartAreaNSplineMax4Border( operationId );
}
 ...
 */
bool cOp2DFibFindEvenPartAreaNSplineMax4Border::run(){
 ...
 */
string cOp2DFibFindEvenPartAreaNSplineMax4Border::getName() const{
	return "cOp2DFibFindEvenPartAreaNSplineMax4Border";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenPartAreaNSplineMax4Border::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenPartAreaNSplineMax4Border::isNull( const double & dValue ){
