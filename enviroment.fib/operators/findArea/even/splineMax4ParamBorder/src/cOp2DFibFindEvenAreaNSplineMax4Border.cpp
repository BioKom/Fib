/**
 * @file cOp2DFibFindEvenAreaNSplineMax4Border
 * file name: cOp2DFibFindEvenAreaNSplineMax4Border.h
...
#include "cOp2DFibFindEvenAreaNSplineMax4Border.h"
 ...
 */
cOp2DFibFindEvenAreaNSplineMax4Border::cOp2DFibFindEvenAreaNSplineMax4Border( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenAreaNSplineMax4Border.
 */
cOp2DFibFindEvenAreaNSplineMax4Border::~cOp2DFibFindEvenAreaNSplineMax4Border(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenAreaNSplineMax4Border * cOp2DFibFindEvenAreaNSplineMax4Border::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenAreaNSplineMax4Border( operationId );
}
 ...
 */
bool cOp2DFibFindEvenAreaNSplineMax4Border::run(){
 ...
 */
string cOp2DFibFindEvenAreaNSplineMax4Border::getName() const{
	return "cOp2DFibFindEvenAreaNSplineMax4Border";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenAreaNSplineMax4Border::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenAreaNSplineMax4Border::isNull( const double & dValue ){
