/**
 * @file cOp2DFibFindEvenAreaSplineMax4BorderOrg
 * file name: cOp2DFibFindEvenAreaSplineMax4BorderOrg.h
...
#include "cOp2DFibFindEvenAreaSplineMax4BorderOrg.h"
 ...
 */
cOp2DFibFindEvenAreaSplineMax4BorderOrg::cOp2DFibFindEvenAreaSplineMax4BorderOrg( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenAreaSplineMax4BorderOrg.
 */
cOp2DFibFindEvenAreaSplineMax4BorderOrg::~cOp2DFibFindEvenAreaSplineMax4BorderOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenAreaSplineMax4BorderOrg * cOp2DFibFindEvenAreaSplineMax4BorderOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenAreaSplineMax4BorderOrg( operationId );
}
 ...
 */
bool cOp2DFibFindEvenAreaSplineMax4BorderOrg::run(){
 ...
 */
string cOp2DFibFindEvenAreaSplineMax4BorderOrg::getName() const{
	return "cOp2DFibFindEvenAreaSplineMax4BorderOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenAreaSplineMax4BorderOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenAreaSplineMax4BorderOrg::isNull( const double & dValue ){
