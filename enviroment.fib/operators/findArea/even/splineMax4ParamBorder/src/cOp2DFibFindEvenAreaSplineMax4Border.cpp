/**
 * @file cOp2DFibFindEvenAreaSplineMax4Border
 * file name: cOp2DFibFindEvenAreaSplineMax4Border.h
...
#include "cOp2DFibFindEvenAreaSplineMax4Border.h"
 ...
 */
cOp2DFibFindEvenAreaSplineMax4Border::cOp2DFibFindEvenAreaSplineMax4Border( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindEvenAreaSplineMax4Border.
 */
cOp2DFibFindEvenAreaSplineMax4Border::~cOp2DFibFindEvenAreaSplineMax4Border(){
	//nothing to do
}
 ...
 */
cOp2DFibFindEvenAreaSplineMax4Border * cOp2DFibFindEvenAreaSplineMax4Border::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindEvenAreaSplineMax4Border( operationId );
}
 ...
 */
bool cOp2DFibFindEvenAreaSplineMax4Border::run(){
 ...
 */
string cOp2DFibFindEvenAreaSplineMax4Border::getName() const{
	return "cOp2DFibFindEvenAreaSplineMax4Border";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindEvenAreaSplineMax4Border::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindEvenAreaSplineMax4Border::isNull( const double & dValue ){
