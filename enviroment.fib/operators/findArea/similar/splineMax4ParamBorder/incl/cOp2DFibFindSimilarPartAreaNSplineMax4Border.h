...
#ifndef ___C_OP_2D_FIB_FIND_SIMILAR_PART_AREA_N_SPLINE_MAX_4_BORDER_H__
#define ___C_OP_2D_FIB_FIND_SIMILAR_PART_AREA_N_SPLINE_MAX_4_BORDER_H__
...
class cOp2DFibFindSimilarPartAreaNSplineMax4Border: public cOperationFib{
public:
	 ...
	 */
	virtual cOp2DFibFindSimilarPartAreaNSplineMax4Border * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindSimilarPartAreaNSplineMax4Border


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_SIMILAR_PART_AREA_N_SPLINE_MAX_4_BORDER_H__
