...
#ifndef ___C_OP_2D_FIB_FIND_SIMILAR_AREA_N_SPLINE_MAX_4_BORDER_ORG_H__
#define ___C_OP_2D_FIB_FIND_SIMILAR_AREA_N_SPLINE_MAX_4_BORDER_ORG_H__
...
class cOp2DFibFindSimilarAreaNSplineMax4BorderOrg: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindSimilarAreaNSplineMax4BorderOrg( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindSimilarAreaNSplineMax4BorderOrg.
	 */
	virtual ~cOp2DFibFindSimilarAreaNSplineMax4BorderOrg();
	 ...
	 */
	virtual cOp2DFibFindSimilarAreaNSplineMax4BorderOrg * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindSimilarAreaNSplineMax4BorderOrg


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_SIMILAR_AREA_N_SPLINE_MAX_4_BORDER_ORG_H__
