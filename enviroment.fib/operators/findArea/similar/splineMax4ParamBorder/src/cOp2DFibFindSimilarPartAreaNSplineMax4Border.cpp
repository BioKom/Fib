/**
 * @file cOp2DFibFindSimilarPartAreaNSplineMax4Border
 * file name: cOp2DFibFindSimilarPartAreaNSplineMax4Border.h
 ...
 */
cOp2DFibFindSimilarPartAreaNSplineMax4Border::cOp2DFibFindSimilarPartAreaNSplineMax4Border( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindSimilarPartAreaNSplineMax4Border.
 */
cOp2DFibFindSimilarPartAreaNSplineMax4Border::~cOp2DFibFindSimilarPartAreaNSplineMax4Border(){
	//nothing to do
}
 ...
 */
cOp2DFibFindSimilarPartAreaNSplineMax4Border * cOp2DFibFindSimilarPartAreaNSplineMax4Border::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindSimilarPartAreaNSplineMax4Border( operationId );
}
 ...
 */
bool cOp2DFibFindSimilarPartAreaNSplineMax4Border::run(){
 ...
 */
string cOp2DFibFindSimilarPartAreaNSplineMax4Border::getName() const{
	return "cOp2DFibFindSimilarPartAreaNSplineMax4Border";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindSimilarPartAreaNSplineMax4Border::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindSimilarPartAreaNSplineMax4Border::isNull( const double & dValue ){
