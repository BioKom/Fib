/**
 * @file cOp2DFibFindSimilarAreaNSplineMax4Border
 * file name: cOp2DFibFindSimilarAreaNSplineMax4Border.h
...
#include "cOp2DFibFindSimilarAreaNSplineMax4Border.h"
 ...
 */
cOp2DFibFindSimilarAreaNSplineMax4Border::cOp2DFibFindSimilarAreaNSplineMax4Border( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindSimilarAreaNSplineMax4Border.
 */
cOp2DFibFindSimilarAreaNSplineMax4Border::~cOp2DFibFindSimilarAreaNSplineMax4Border(){
	//nothing to do
}
 ...
 */
cOp2DFibFindSimilarAreaNSplineMax4Border * cOp2DFibFindSimilarAreaNSplineMax4Border::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindSimilarAreaNSplineMax4Border( operationId );
}
 ...
 */
bool cOp2DFibFindSimilarAreaNSplineMax4Border::run(){
 ...
 */
string cOp2DFibFindSimilarAreaNSplineMax4Border::getName() const{
	return "cOp2DFibFindSimilarAreaNSplineMax4Border";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindSimilarAreaNSplineMax4Border::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindSimilarAreaNSplineMax4Border::isNull( const double & dValue ){
