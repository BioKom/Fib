/**
 * @file cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg
 * file name: cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg.h
...
#include "cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg.h"
 ...
 */
cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg::cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg.
 */
cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg::~cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg * cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg( operationId );
}
 ...
 */
bool cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg::run(){
 ...
 */
string cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg::getName() const{
	return "cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindSimilarPartAreaNSplineMax4BorderOrg::isNull( const double & dValue ){
