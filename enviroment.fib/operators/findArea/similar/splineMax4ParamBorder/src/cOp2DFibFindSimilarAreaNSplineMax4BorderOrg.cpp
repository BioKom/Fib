/**
 * @file cOp2DFibFindSimilarAreaNSplineMax4BorderOrg
 * file name: cOp2DFibFindSimilarAreaNSplineMax4BorderOrg.h
...
#include "cOp2DFibFindSimilarAreaNSplineMax4BorderOrg.h"
 ...
 */
cOp2DFibFindSimilarAreaNSplineMax4BorderOrg::cOp2DFibFindSimilarAreaNSplineMax4BorderOrg( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindSimilarAreaNSplineMax4BorderOrg.
 */
cOp2DFibFindSimilarAreaNSplineMax4BorderOrg::~cOp2DFibFindSimilarAreaNSplineMax4BorderOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindSimilarAreaNSplineMax4BorderOrg * cOp2DFibFindSimilarAreaNSplineMax4BorderOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindSimilarAreaNSplineMax4BorderOrg( operationId );
}
 ...
 */
bool cOp2DFibFindSimilarAreaNSplineMax4BorderOrg::run(){
 ...
 */
string cOp2DFibFindSimilarAreaNSplineMax4BorderOrg::getName() const{
	return "cOp2DFibFindSimilarAreaNSplineMax4BorderOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindSimilarAreaNSplineMax4BorderOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindSimilarAreaNSplineMax4BorderOrg::isNull( const double & dValue ){
