/**
 * @file cOp2DFibFindSimilarAreaN
 * file name: cOp2DFibFindSimilarAreaN.h
...
#include "cOp2DFibFindSimilarAreaN.h"
 ...
 */
cOp2DFibFindSimilarAreaN::cOp2DFibFindSimilarAreaN( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindSimilarAreaN.
 */
cOp2DFibFindSimilarAreaN::~cOp2DFibFindSimilarAreaN(){
	//nothing to do
}
 ...
 */
cOp2DFibFindSimilarAreaN * cOp2DFibFindSimilarAreaN::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindSimilarAreaN( operationId );
}
 ...
 */
bool cOp2DFibFindSimilarAreaN::run(){
 ...
 */
string cOp2DFibFindSimilarAreaN::getName() const{
	return "cOp2DFibFindSimilarAreaN";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindSimilarAreaN::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindSimilarAreaN::isNull( const double & dValue ){
