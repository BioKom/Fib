...
#include "cOp2DFibFindSimilarPartAreaNOrg.h"
 ...
 */
cOp2DFibFindSimilarPartAreaNOrg::cOp2DFibFindSimilarPartAreaNOrg( const cOperationIdentifier & operationId ):
 ...
 */
cOp2DFibFindSimilarPartAreaNOrg::~cOp2DFibFindSimilarPartAreaNOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindSimilarPartAreaNOrg * cOp2DFibFindSimilarPartAreaNOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindSimilarPartAreaNOrg( operationId );
}
 ...
 */
bool cOp2DFibFindSimilarPartAreaNOrg::run(){
 ...
 */
string cOp2DFibFindSimilarPartAreaNOrg::getName() const{
	return "cOp2DFibFindSimilarPartAreaNOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindSimilarPartAreaNOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindSimilarPartAreaNOrg::isNull( const double & dValue ){
