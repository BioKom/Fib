...
#ifndef ___C_OP_2D_FIB_FIND_SIMILAR_AREA_N_ORG_H__
#define ___C_OP_2D_FIB_FIND_SIMILAR_AREA_N_ORG_H__
...
class cOp2DFibFindSimilarAreaNOrg: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindSimilarAreaNOrg( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindSimilarAreaNOrg.
	 */
	virtual ~cOp2DFibFindSimilarAreaNOrg();
	 ...
	 */
	virtual cOp2DFibFindSimilarAreaNOrg * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindSimilarAreaNOrg


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_SIMILAR_AREA_N_ORG_H__
