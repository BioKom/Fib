...
#ifndef ___C_OP_2D_FIB_FIND_SIMILAR_AREA_N_H__
#define ___C_OP_2D_FIB_FIND_SIMILAR_AREA_N_H__
...
class cOp2DFibFindSimilarAreaN: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindSimilarAreaN( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindSimilarAreaN.
	 */
	virtual ~cOp2DFibFindSimilarAreaN();
	 ...
	 */
	virtual cOp2DFibFindSimilarAreaN * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindSimilarAreaN


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_SIMILAR_AREA_N_H__
