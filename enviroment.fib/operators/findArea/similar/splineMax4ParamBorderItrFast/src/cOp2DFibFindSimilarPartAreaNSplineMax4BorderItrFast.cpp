/**
 * @file cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast
 * file name: cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast.h
...
#include "cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast.h"
 ...
 */
cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast::cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast.
 */
cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast::~cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast(){
	//nothing to do
}
 ...
 */
cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast * cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast( operationId );
}
 ...
 */
bool cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast::run(){
	...
	if ( itrPoint == evaluedPositionsData.liEvaluedPositionData.end() ){
 ...
 */
string cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast::getName() const{
	return "cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFast::isNull( const double & dValue ){
