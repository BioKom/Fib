/**
 * @file cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg
 * file name: cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg.h
...
#include "cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg.h"
 ...
 */
cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg::cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg.
 */
cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg::~cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg * cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg( operationId );
}
 ...
 */
bool cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg::run(){
 ...
 */
string cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg::getName() const{
	return "cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindSimilarPartAreaNSplineMax4BorderItrFastOrg::isNull( const double & dValue ){
