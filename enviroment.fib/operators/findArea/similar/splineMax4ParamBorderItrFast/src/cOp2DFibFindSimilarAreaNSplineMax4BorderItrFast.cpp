/**
 * @file cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast
 * file name: cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast.h
...
#include "cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast.h"
 ...
 */
cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast::cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast( const cOperationIdentifier & operationId ):
...
/**
 * Destructor of the class cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast.
 */
cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast::~cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast(){
	//nothing to do
}
 ...
 */
cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast * cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast( operationId );
}
 ...
 */
bool cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast::run(){
 ...
 */
string cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast::getName() const{
	return "cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast::isNull( const double & dValue ){
