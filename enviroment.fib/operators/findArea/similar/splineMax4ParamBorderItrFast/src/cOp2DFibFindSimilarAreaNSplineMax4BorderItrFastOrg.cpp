...
#include "cOp2DFibFindSimilarAreaNSplineMax4BorderItrFastOrg.h"
 ...
 */
cOp2DFibFindSimilarAreaNSplineMax4BorderItrFastOrg::cOp2DFibFindSimilarAreaNSplineMax4BorderItrFastOrg( const cOperationIdentifier & operationId ):
 ...
 */
cOp2DFibFindSimilarAreaNSplineMax4BorderItrFastOrg::~cOp2DFibFindSimilarAreaNSplineMax4BorderItrFastOrg(){
	//nothing to do
}
 ...
 */
cOp2DFibFindSimilarAreaNSplineMax4BorderItrFastOrg * cOp2DFibFindSimilarAreaNSplineMax4BorderItrFastOrg::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOp2DFibFindSimilarAreaNSplineMax4BorderItrFastOrg( operationId );
}
 ...
 */
bool cOp2DFibFindSimilarAreaNSplineMax4BorderItrFastOrg::run(){
 ...
 */
string cOp2DFibFindSimilarAreaNSplineMax4BorderItrFastOrg::getName() const{
	return "cOp2DFibFindSimilarAreaNSplineMax4BorderItrFastOrg";
}
 ...
 * 	first pair is lower
 */
bool cOp2DFibFindSimilarAreaNSplineMax4BorderItrFastOrg::lowerPropertyElement(
 ...
 */
bool cOp2DFibFindSimilarAreaNSplineMax4BorderItrFastOrg::isNull( const double & dValue ){
