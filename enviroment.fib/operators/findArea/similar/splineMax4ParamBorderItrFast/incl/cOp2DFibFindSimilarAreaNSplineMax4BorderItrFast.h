...
#ifndef ___C_OP_2D_FIB_FIND_SIMILAR_AREA_N_SPLINE_MAX_4_BORDER_ITR_FAST_H__
#define ___C_OP_2D_FIB_FIND_SIMILAR_AREA_N_SPLINE_MAX_4_BORDER_ITR_FAST_H__
...
class cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast: public cOperationFib{
public:
	 ...
	 */
	cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast.
	 */
	virtual ~cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast();
	 ...
	 */
	virtual cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOp2DFibFindSimilarAreaNSplineMax4BorderItrFast


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_2D_FIB_FIND_SIMILAR_AREA_N_SPLINE_MAX_4_BORDER_ITR_FAST_H__
