 ...
 * file name: cOpRemoveOverwrittenUnderObjects.h
...
#ifndef ___C_OP_REMOVE_OVERWRITTEN_UNDER_OBJECS_H__
#define ___C_OP_REMOVE_OVERWRITTEN_UNDER_OBJECS_H__
...
class cOpRemoveOverwrittenUnderObjects: public cOperationFib{
public:
	 ...
	 */
	virtual cOpRemoveOverwrittenUnderObjects * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOpRemoveOverwrittenUnderObjects


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_REMOVE_OVERWRITTEN_UNDER_OBJECS_H__perator
