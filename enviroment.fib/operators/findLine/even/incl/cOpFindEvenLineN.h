/**
 * @file cOpFindEvenLineN
 * file name: cOpFindEvenLineN.h
...
/*
History:
26.06.2010  Oesterholz  created
*/


#ifndef ___C_OP_FIND_EVEN_LINE_N_H__
#define ___C_OP_FIND_EVEN_LINE_N_H__
...
class cOpFindEvenLineN: public cOperationFib{
public:
	 ...
	 */
	cOpFindEvenLineN( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOpFindEvenLineN.
	 */
	virtual ~cOpFindEvenLineN();
	 ...
	 */
	virtual cOpFindEvenLineN * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOpFindEvenLineN


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_FIND_EVEN_LINE_N_H__perator
