 ...
 * file name: cOpFindSimilarLineNBi2.cpp
...
#include "cOpFindSimilarLineNBi2.h"
 ...
 */
cOpFindSimilarLineNBi2::cOpFindSimilarLineNBi2( const cOperationIdentifier & operationId ):
 ...
 */
cOpFindSimilarLineNBi2::~cOpFindSimilarLineNBi2(){
	//nothing to do
}
 ...
 */
cOpFindSimilarLineNBi2 * cOpFindSimilarLineNBi2::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOpFindSimilarLineNBi2( operationId );
}
 ...
 */
bool cOpFindSimilarLineNBi2::run(){
	...
	//choose random point
	size_t iChoosenPoint = rand() % evaluedPositionsDataOriginal.
 ...
 */
string cOpFindSimilarLineNBi2::getName() const{
	return "cOpFindSimilarLineNBi2";
}
