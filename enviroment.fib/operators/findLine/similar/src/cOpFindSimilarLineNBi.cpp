 ...
 * file name: cOpFindSimilarLineNBi.cpp
...
#include "cOpFindSimilarLineNBi.h"
 ...
 */
cOpFindSimilarLineNBi::cOpFindSimilarLineNBi( const cOperationIdentifier & operationId ):
 ...
 */
cOpFindSimilarLineNBi::~cOpFindSimilarLineNBi(){
	//nothing to do
}
 ...
 */
cOpFindSimilarLineNBi * cOpFindSimilarLineNBi::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOpFindSimilarLineNBi( operationId );
}
 ...
 */
bool cOpFindSimilarLineNBi::run(){
 ...
 */
string cOpFindSimilarLineNBi::getName() const{
	return "cOpFindSimilarLineNBi";
}
