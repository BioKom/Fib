 ...
 * file name: cOpFindSimilarLineAll.cpp
...
#include "cOpFindSimilarLineAll.h"
 ...
 */
cOpFindSimilarLineAll::cOpFindSimilarLineAll( const cOperationIdentifier & operationId ):
 ...
 */
cOpFindSimilarLineAll::~cOpFindSimilarLineAll(){
	//nothing to do
}
 ...
 */
cOpFindSimilarLineAll * cOpFindSimilarLineAll::createInstance(
		const cOperationIdentifier & operationId ) const{
	
	return new cOpFindSimilarLineAll( operationId );
}
 ...
 */
bool cOpFindSimilarLineAll::run(){
 ...
 */
string cOpFindSimilarLineAll::getName() const{
	return "cOpFindSimilarLineAll";
}
