 ...
 * file name: cOpFindSimilarLine.h
...
#ifndef ___C_OP_FIND_EVEN_SIMILAR_H__
#define ___C_OP_FIND_EVEN_SIMILAR_H__
...
class cOpFindSimilarLine: public cOperationFib{
public:
	 ...
	 */
	cOpFindSimilarLine( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOpFindSimilarLine.
	 */
	virtual ~cOpFindSimilarLine();
	 ...
	 */
	virtual cOpFindSimilarLine * createInstance( const cOperationIdentifier & operationId ) const;
