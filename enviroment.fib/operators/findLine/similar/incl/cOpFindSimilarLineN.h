 ...
 * file name: cOpFindSimilarLineN.h
...
#ifndef ___C_OP_FIND_SIMILAR_LINE_N_H__
#define ___C_OP_FIND_SIMILAR_LINE_N_H__
...
class cOpFindSimilarLineN: public cOperationFib{
public:
	 ...
	 */
	cOpFindSimilarLineN( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOpFindSimilarLineN.
	 */
	virtual ~cOpFindSimilarLineN();
	 ...
	 */
	virtual cOpFindSimilarLineN * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOpFindSimilarLineN


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_FIND_SIMILAR_LINE_N_H__perator
