...
class cOpFindSimilarLineNBi2: public cOperationFib{
public:
	 ...
	 */
	cOpFindSimilarLineNBi2( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOpFindSimilarLineNBi2.
	 */
	virtual ~cOpFindSimilarLineNBi2();
	 ...
	 */
	virtual cOpFindSimilarLineNBi2 * createInstance( const cOperationIdentifier & operationId ) const;
