 ...
 * file name: cOpFindSimilarLineAll2.h
...
#ifndef ___C_OP_FIND_SIMILAR_LINE_ALL_2_H__
#define ___C_OP_FIND_SIMILAR_LINE_ALL_2_H__
...
class cOpFindSimilarLineAll2: public cOperationFib{
public:
	 ...
	 */
	cOpFindSimilarLineAll2( const cOperationIdentifier & operationId );

	/**
	 * Destructor of the class cOpFindSimilarLineAll2.
	 */
	virtual ~cOpFindSimilarLineAll2();
	 ...
	 */
	virtual cOpFindSimilarLineAll2 * createInstance( const cOperationIdentifier & operationId ) const;
...
};//end class cOpFindSimilarLineAll2


};//end namespace fib
};//end namespace enviroment

#endif //___C_OP_FIND_SIMILAR_LINE_ALL_2_H__perator
