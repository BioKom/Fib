...
% erstellt: 15.05.2011
% This is the small handout for the Fib project.
%
...
\begin{window}[0,r,\includegraphics[scale=0.2]{./pictures/order_elements.eps},{}]
\noindent
The Fib multimedia format (Fib language) is used to store multimedia information in a structured, functional and hierarchical form. The structure of the Fib format supports the object view of things. The Fib format is very powerful, since expressions can be combined and nested (modular system).
\textbf{With Fib the question is not whether you can do something, but just how to do something.}
The memory cost of a multimedia object in Fib is much more dependent on its complexity as of its size (in terms of expansion in the dimensions, for example, the number of points in images).
...
\begin{window}[0,l,\includegraphics[scale=0.3]{./pictures/algorithmus.eps},{}]
\noindent
