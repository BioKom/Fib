...
\begin{longtable}{|p{23mm}|p{60mm}|p{40mm}|}\hline
	...
	connectedTo::XXX & The value to the key is the identifier (a number) of the object, which has the connection XXX to the actual object. For example ``connectedTo::sameType'' means that the object to the identifier is of the same type as the actual object. & (connectedTo::sameType , ``-156'') \\\hline
