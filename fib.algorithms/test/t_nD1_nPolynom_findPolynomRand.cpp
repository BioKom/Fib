/**
 * @file t_nD1_cPolynom_findPolynomRand
 * file name: t_nD1_cPolynom_findPolynomRand.cpp
 ...
 * System: C++
 *
 * This test is for the function nD1::cPolynom::findPolynomRand() .
 *
 ...
 *
 *
 * This test is for the function nD1::cPolynom::findFunctionRand() .
 *
 */
/*
History:
13.06.2010  Oesterholz  created
*/
...
int main(int argc, char* argv[]){
	...
	cout<<endl<<"Running Test for the function nD1::cPolynom::findPolynomRand()"<<endl;
	cout<<      "=============================================================="<<endl;
...
//	const long lMaxX = lMinX + (rand() % 1024) + 1;
	...
	const unsigned long ulMaxIterations = 256 * 256;
	cPolynom<long, double> polynomFound;
	polynomFound.findFunctionRand( vecData, ulMaxIterations );
	
	cout<<endl<<"original polynom:"<<endl;
	polynomOriginal.print( cout );
	cout<<endl<<"Founded polynom (iterations="<< ulMaxIterations <<"):"<<endl;
	polynomFound.print( cout );
	
	//evalue error
	const pair<unsigned long, double> paErrorValue = polynomFound.evalueError( vecData );
