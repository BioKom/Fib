/**
 * @file iImageStructureOperator
 * file name: iImageStructureOperator.h
 ...
 * The operator will change an image structure.
 *
 * @pattern Strategy
 * @see cImageStructure
...
#ifndef ___FIB__ALGORITHMS__N_CONVERT_TO_FIB__N_IMAGE__N_STRUCTURE_DATA__N_OPERATORS__I_IMAGE_STRUCTURE_OPERATOR_H__
#define ___FIB__ALGORITHMS__N_CONVERT_TO_FIB__N_IMAGE__N_STRUCTURE_DATA__N_OPERATORS__I_IMAGE_STRUCTURE_OPERATOR_H__
...
class iImageStructureOperator: public iImageStructureSearchOperator{
public:
	
	/**
	 * destructor
	 */
	virtual ~iImageStructureOperator(){};
	 ...
	 */
	virtual bool operator()( cImageStructure * pImageStructure ) const = 0;
...
};//interface iImageStructureOperator
...
#endif //___FIB__ALGORITHMS__N_CONVERT_TO_FIB__N_IMAGE__N_STRUCTURE_DATA__N_OPERATORS__I_IMAGE_STRUCTURE_OPERATOR_H__
