...
#ifndef ___C_USE_CONVERT_AREA_TO_EXT_OBJECTS_STRATEGY_H__
#define ___C_USE_CONVERT_AREA_TO_EXT_OBJECTS_STRATEGY_H__
...
#endif //___C_USE_CONVERT_AREA_TO_EXT_OBJECTS_STRATEGY_H__