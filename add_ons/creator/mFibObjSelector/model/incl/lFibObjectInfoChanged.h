...
#ifndef ___FIB__NCREATOR__L_FIB_OBJECT_INFO_CHANGED_H__
#define ___FIB__NCREATOR__L_FIB_OBJECT_INFO_CHANGED_H__
...
public:
	...
	/**
	 * @return the name of this class "lFibObjectInfoChanged"
	 */
	virtual std::string getName() const = 0;
	
};//end class lFibObjectInfoChanged

};//end namespace nCreator
};//end namespace fib

#endif //___FIB__NCREATOR__L_FIB_OBJECT_INFO_CHANGED_H__
