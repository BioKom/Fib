...
echo
#evaluate testcases
${MEM_CHECKER} ./mFibObjSelector/model/testcase/tFibObjectSourceFibDb >> ${OUTPUT} 2>> ${ERROR_OUTPUT}
ERRORS=$?
ERROR_SUM=$(expr ${ERROR_SUM} + ${ERRORS})
echo "Errors in tFibObjectSourceFibDb (1=yes;0=no): ${ERRORS}" >> ${SUM_OUTPUT}

${MEM_CHECKER} ./mFibObjSelector/model/testcase/tFibObjectSourcePath >> ${OUTPUT} 2>> ${ERROR_OUTPUT}
ERRORS=$?
ERROR_SUM=$(expr ${ERROR_SUM} + ${ERRORS})
echo "Errors in tFibObjectSourcePath (1=yes;0=no): ${ERRORS}" >> ${SUM_OUTPUT}

${MEM_CHECKER} ./mFibObjSelector/model/testcase/tFibObjectInfo >> ${OUTPUT} 2>> ${ERROR_OUTPUT}
ERRORS=$?
ERROR_SUM=$(expr ${ERROR_SUM} + ${ERRORS})
echo "Errors in tFibObjectInfo (1=yes;0=no): ${ERRORS}" >> ${SUM_OUTPUT}

${MEM_CHECKER} ./control/testcase/tFibNodeHandler_integrateFibObjectIntoNode >> ${OUTPUT} 2>> ${ERROR_OUTPUT}
ERRORS=$?
ERROR_SUM=$(expr ${ERROR_SUM} + ${ERRORS})
echo "Errors in tFibNodeHandler_integrateFibObjectIntoNode (1=yes;0=no): ${ERRORS}" >> ${SUM_OUTPUT}
