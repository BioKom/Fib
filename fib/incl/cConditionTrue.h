...
#ifndef ___C_CONDITION_TRUE_H__
#define ___C_CONDITION_TRUE_H__
...
class cConditionTrue: public cCondition{
public:
	 ...
	 * 	the new condition
	 */
	cConditionTrue( cCondition * pInSuperiorCondition = NULL,
	 ...
	 * 	the new condition
	 */
	cConditionTrue( const cConditionTrue & condition,
...
};//end class cConditionTrue


}//end namespace Fib

#endif //___C_CONDITION_TRUE_H__
