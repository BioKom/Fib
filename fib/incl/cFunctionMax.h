...
#ifndef ___C_FUNCTION_MAX_H__
#define ___C_FUNCTION_MAX_H__
...
class cFunctionMax: public cFunctionTwoValue{
...
public:
	 ...
	 */
	cFunctionMax( const cUnderFunction & firstUnderfunction,
	 ...
	 * 	the new underfunction
	 */
	cFunctionMax( const cFunctionMax & underfunction,
		cUnderFunction * pInSuperiorFunction = NULL,
		cFibElement *pInDefiningFibElement = NULL );
	 ...
	 * 	the new underfunction
	 */
	cFunctionMax( const TiXmlElement * pXmlElement, intFib & outStatus,
	 ...
	 * 	the new underfunction
	 */
	cFunctionMax( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
