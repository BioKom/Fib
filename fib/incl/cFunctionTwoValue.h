...
#ifndef ___C_FUNCTION_TWO_VALUE_H__
#define ___C_FUNCTION_TWO_VALUE_H__
...
class cFunctionTwoValue: public cUnderFunction{
...
public:
	 ...
	 */
	cFunctionTwoValue( const cUnderFunction & firstUnderfunction,
	 ...
	 * 	the new underfunction
	 */
	cFunctionTwoValue( cUnderFunction * pInFirstUnderfunction,
	 ...
	 * 	the new underfunction
	 */
	cFunctionTwoValue( const cFunctionTwoValue & underfunction,
		cUnderFunction * pInSuperiorFunction = NULL,
		cFibElement *pInDefiningFibElement = NULL );
	 ...
	 * 	the new underfunction
	 */
	cFunctionTwoValue( const TiXmlElement * pXmlElement, intFib & outStatus,
	 ...
	 * 	the new underfunction
	 */
	cFunctionTwoValue( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
	 ...
	 */
	void setFirstUnderFunction( const cUnderFunction & underFunction,
	 ...
	 * 	memory, else the old underfunction should be deleted elswher
	 */
	void setSecondUnderFunction( const cUnderFunction & underFunction,
		bool bDeleteOld=true );
