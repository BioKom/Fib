...
#ifndef ___C_FUNCTION_MIN_H__
#define ___C_FUNCTION_MIN_H__
...
class cFunctionMin: public cFunctionTwoValue{
...
public:
	 ...
	 */
	cFunctionMin( const cUnderFunction & firstUnderfunction,
	 ...
	 * 	the new underfunction
	 */
	cFunctionMin( const cFunctionMin & underfunction,
		cUnderFunction * pInSuperiorFunction = NULL,
		cFibElement *pInDefiningFibElement = NULL );
	 ...
	 * 	the new underfunction
	 */
	cFunctionMin( const TiXmlElement * pXmlElement, intFib & outStatus,
	 ...
	 * 	the new underfunction
	 */
	cFunctionMin( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
