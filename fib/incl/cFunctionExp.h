...
#ifndef ___C_FUNCTION_EXP_H__
#define ___C_FUNCTION_EXP_H__
...
class cFunctionExp: public cFunctionTwoValue{
...
public:
	 ...
	 */
	cFunctionExp( const cUnderFunction & firstUnderfunction,
	 ...
	 * 	the new underfunction
	 */
	cFunctionExp( const cFunctionExp & underfunction,
		cUnderFunction * pInSuperiorFunction = NULL,
		cFibElement *pInDefiningFibElement = NULL );
	 ...
	 * 	the new underfunction
	 */
	cFunctionExp( const TiXmlElement * pXmlElement, intFib & outStatus,
	 ...
	 * 	the new underfunction
	 */
	cFunctionExp( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
