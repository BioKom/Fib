...
#ifndef ___C_DOMAIN_NATURAL_NUMBER_BIT_H__
#define ___C_DOMAIN_NATURAL_NUMBER_BIT_H__
...
class cDomainIntegerBit;//cyclic dependencie


class cDomainNaturalNumberBit: public cDomainIntegerBasis{
protected:

friend class cDomainIntegerBit;

	/**
	 * The number of bits for the natural numbers in this domain.
	 */
	unsignedIntFib iBitsForDomainNumbers;
...
public:
	 ...
	 */
	virtual cDomainNaturalNumberBit *clone() const;
...
};//end class cDomainNaturalNumberBit
