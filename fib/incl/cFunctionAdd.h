...
#ifndef ___C_FUNCTION_ADD_H__
#define ___C_FUNCTION_ADD_H__
...
class cFunctionAdd: public cFunctionTwoValue{
...
public:
	 ...
	 */
	cFunctionAdd( const cUnderFunction & firstUnderfunction,
	 ...
	 * 	the new underfunction
	 */
	cFunctionAdd( const cFunctionAdd & underfunction,
		cUnderFunction * pInSuperiorFunction = NULL,
		cFibElement *pInDefiningFibElement = NULL );
	 ...
	 * 	the new underfunction
	 */
	cFunctionAdd( const TiXmlElement * pXmlElement, intFib & outStatus,
	 ...
	 * 	the new underfunction
	 */
	cFunctionAdd( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
