...
#ifndef ___C_FUNCTION_ARCSIN_H__
#define ___C_FUNCTION_ARCSIN_H__
...
class cFunctionArcsin: public cFunctionOneValue{
...
public:
	 ...
	 */
	cFunctionArcsin( const cUnderFunction * const pUnderfunction,
	 ...
	 * 	the new underfunction
	 */
	cFunctionArcsin( const cFunctionArcsin & underfunction,
		cUnderFunction * pInSuperiorFunction = NULL,
		cFibElement *pInDefiningFibElement = NULL );
	 ...
	 * 	the new underfunction
	 */
	cFunctionArcsin( const TiXmlElement * pXmlElement, intFib & outStatus,
	 ...
	 * 	the new underfunction
	 */
	cFunctionArcsin( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
