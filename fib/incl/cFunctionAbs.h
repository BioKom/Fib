...
#ifndef ___C_FUNCTION_ABS_H__
#define ___C_FUNCTION_ABS_H__
...
class cFunctionAbs: public cFunctionOneValue{
...
public:
	 ...
	 */
	cFunctionAbs( const cUnderFunction * const pUnderfunction,
	 ...
	 * 	the new underfunction
	 */
	cFunctionAbs( const cFunctionAbs & underfunction,
		cUnderFunction * pInSuperiorFunction = NULL,
		cFibElement *pInDefiningFibElement = NULL );
	 ...
	 * 	the new underfunction
	 */
	cFunctionAbs( const TiXmlElement * pXmlElement, intFib & outStatus,
	 ...
	 * 	the new underfunction
	 */
	cFunctionAbs( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
