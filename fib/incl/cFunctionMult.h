 ...
 * System: C++
 *
 * This class represents a Fib -function for multiplication.
 ...
 *
 * This class represents a Fib -function for multiplication.
 * This function works on two underfunctions which values are multiplicated.
...
#ifndef ___C_FUNCTION_MULT_H__
#define ___C_FUNCTION_MULT_H__
...
class cFunctionMult: public cFunctionTwoValue{
...
public:
	 ...
	 */
	cFunctionMult( const cUnderFunction & firstUnderfunction,
	 ...
	 * 	the new underfunction
	 */
	cFunctionMult( const cFunctionMult & underfunction,
		cUnderFunction * pInSuperiorFunction = NULL,
		cFibElement *pInDefiningFibElement = NULL );
	 ...
	 * 	the new underfunction
	 */
	cFunctionMult( const TiXmlElement * pXmlElement, intFib & outStatus,
	 ...
	 * 	the new underfunction
	 */
	cFunctionMult( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
