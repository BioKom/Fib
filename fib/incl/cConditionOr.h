...
#ifndef ___C_CONDITION_OR_H__
#define ___C_CONDITION_OR_H__
...
class cConditionOr: public cConditionTwoValue{
...
public:
	 ...
	 * 	the new condition
	 */
	cConditionOr( cCondition * pInFirstSubCondition,
	 ...
	 * 	the new condition
	 */
	cConditionOr( const cCondition & inFirstSubCondition,
	 ...
	 * 	the new condition
	 */
	cConditionOr( const cConditionOr & condition,
		cCondition * pInSuperiorCondition = NULL,
		cFibElement *pInDefiningFibElement = NULL );
...
};//end class cConditionOr


}//end namespace Fib

#endif //___C_CONDITION_OR_H__
