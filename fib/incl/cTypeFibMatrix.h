 ...
 * System: C++
 *
 * This class represents Fib matrix element type.
...
#ifndef ___C_TYPE_FIB_MATRIX_H__
#define ___C_TYPE_FIB_MATRIX_H__
...
class cTypeFibMatrix: public cTypeElement{
private:
	/**
	 * The number of the matrix element domain for which this type stands.
	 */
...
public:
	 ...
	 */
	cTypeFibMatrix( const unsignedIntFib uiInNumberOfDomain = 0 );
	 ...
	 */
	cTypeFibMatrix( const cTypeFibMatrix &typeExternObject );
	 ...
	 * domain for elements of this matrix element type.
	 ...
	 */
	virtual cTypeFibMatrix *clone() const;
...
};//end class cTypeFibMatrix


}//end namespace fib

#endif //___C_TYPE_FIB_MATRIX_H__
