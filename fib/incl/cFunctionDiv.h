...
#ifndef ___C_FUNCTION_DIV_H__
#define ___C_FUNCTION_DIV_H__
...
class cFunctionDiv: public cFunctionTwoValue{
...
public:
	 ...
	 */
	cFunctionDiv( const cUnderFunction & firstUnderfunction,
	 ...
	 * 	the new underfunction
	 */
	cFunctionDiv( const cFunctionDiv & underfunction,
		cUnderFunction * pInSuperiorFunction = NULL,
		cFibElement *pInDefiningFibElement = NULL );
	 ...
	 * 	the new underfunction
	 */
	cFunctionDiv( const TiXmlElement * pXmlElement, intFib & outStatus,
	 ...
	 * 	the new underfunction
	 */
	cFunctionDiv( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
