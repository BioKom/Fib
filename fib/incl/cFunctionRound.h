...
#ifndef ___C_FUNCTION_ROUND_H__
#define ___C_FUNCTION_ROUND_H__
...
class cFunctionRound: public cFunctionOneValue{
...
public:
	 ...
	 */
	cFunctionRound( const cUnderFunction * const pUnderfunction,
	 ...
	 * 	the new underfunction
	 */
	cFunctionRound( const cFunctionRound & underfunction,
		cUnderFunction * pInSuperiorFunction = NULL,
		cFibElement *pInDefiningFibElement = NULL );
	 ...
	 * 	the new underfunction
	 */
	cFunctionRound( const TiXmlElement * pXmlElement, intFib & outStatus,
	 ...
	 * 	the new underfunction
	 */
	cFunctionRound( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
