...
#ifndef ___C_TYPE_COMMENTS_H__
#define ___C_TYPE_COMMENTS_H__
...
class cTypeComments: public cTypeElement{
...
public:
	 ...
	 */
	virtual cTypeComments * clone() const;
...
};//end class cTypeComments


}//end namespace fib

#endif //___C_TYPE_COMMENTS_H__
