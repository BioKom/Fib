 ...
 * System: C++
 *
 * This class represents a Fib -function for the maximum evaluation.
 ...
 *
 * This class represents a Fib -function for the maximum evaluation.
 * This function realisises the maximum of it's two underfunctions.
 * ( max( underfunction1, underfunction2) )
 *
 */
/*
History:
 ...
 */
cFunctionMax::cFunctionMax( const cUnderFunction & firstUnderfunction,
 ...
 * 	the new underfunction
 */
cFunctionMax::cFunctionMax( const cFunctionMax & underfunction,
		cUnderFunction * pInSuperiorFunction,
		cFibElement *pInDefiningFibElement ):
 ...
 * 	the new underfunction
 */
cFunctionMax::cFunctionMax( const TiXmlElement * pXmlElement, intFib & outStatus,
 ...
 * 	the new underfunction
 */
cFunctionMax::cFunctionMax( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
 ...
 * 	such exists
 */
doubleFib cFunctionMax::getValue() const{
 ...
 */
bool cFunctionMax::store( ostream & stream, char & cRestBits,
	...
	//store the identifier for the function max
	char cInitiation = 0x1B;
 ...
 */
unsignedIntFib cFunctionMax::getType() const{
 ...
 */
string cFunctionMax::getUnderFunctionName() const{
 ...
 */
cFunctionMax * cFunctionMax::clone(
		cUnderFunction * pInSuperiorUnderFunction,
		cFibElement *pInDefiningFibElement ) const{
	
	return new cFunctionMax( * this, pInSuperiorUnderFunction,
		pInDefiningFibElement );
}
