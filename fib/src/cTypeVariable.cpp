 ...
 * System: C++
 *
 * This class represents an Fib -variablecountertype.
 ...
 *
 *
 * This file contains the basisclass of all Fib -variablecountertype.
 * Fib -variablecountertype are typs for the number of variables, when
 * they are stored. When saving variables they will be numbered serially,
 * the numbers of the variables will come from the domain for the
 * cTypeVariable.
 *
 */
/*
History:
19.11.2009  Oesterholz  created
...
/**
 * Standardconstructor for the variablen type.
 */
cTypeVariable::cTypeVariable(){
	//nothing to do
}
 ...
 */
unsignedIntFib cTypeVariable::getType() const{
	return 10;
}
 ...
 */
bool cTypeVariable::isCompatible( const cDomain &domain ) const{
 ...
 */
cDomain * cTypeVariable::getStandardDomain() const{
 ...
 */
bool cTypeVariable::operator==( const cTypeElement & typeElement ) const{
 ...
 */
cTypeVariable * cTypeVariable::clone() const{
 ...
 */
unsignedLongFib cTypeVariable::getCompressedSize() const{
 ...
 */
bool cTypeVariable::storeXml( ostream & ostream,
 ...
 */
cDomain * cTypeVariable::restoreXmlWithDomain( const TiXmlElement * pXmlElement,
 ...
 */
bool cTypeVariable::store( ostream & stream, char & cRestBits,
	...
	char cInVarName = 0x88; //the name "variable"
 ...
 * 			object is wrong
 */
intFib cTypeVariable::restore( cReadBits & iBitStream ){
