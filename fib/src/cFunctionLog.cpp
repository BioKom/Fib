 ...
 * System: C++
 *
 * This class represents a Fib -function for the logarithm evaluation.
 ...
 *
 * This class represents a Fib -function for the logarithm evaluation.
 * This function realisises the natural logarithm of it's one underfunction.
 * ( log( underfunction ) )
 *
 */
/*
 ...
 */
cFunctionLog::cFunctionLog( const cUnderFunction * const pUnderfunction,
 ...
 * 	the new underfunction
 */
cFunctionLog::cFunctionLog( const cFunctionLog & underfunction,
		cUnderFunction * pInSuperiorFunction,
		cFibElement *pInDefiningFibElement ):
 ...
 * 	the new underfunction
 */
cFunctionLog::cFunctionLog( const TiXmlElement * pXmlElement, intFib & outStatus,
 ...
 * 	the new underfunction
 */
cFunctionLog::cFunctionLog( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
 ...
 * 	such exists
 */
doubleFib cFunctionLog::getValue() const{
 ...
 */
unsignedLongFib cFunctionLog::getCompressedSize() const{
 ...
 */
bool cFunctionLog::store( ostream & stream, char & cRestBits,
	...
	//store the identifier for the function log
	char cInitiation = 0x0A;
 ...
 */
unsignedIntFib cFunctionLog::getType() const{
 ...
 */
string cFunctionLog::getUnderFunctionName() const{
 ...
 */
cFunctionLog * cFunctionLog::clone(
		cUnderFunction * pInSuperiorUnderFunction,
		cFibElement *pInDefiningFibElement ) const{
	
	return new cFunctionLog( * this, pInSuperiorUnderFunction,
		pInDefiningFibElement );
}
