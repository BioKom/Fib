 ...
 */
cFunctionSub::cFunctionSub( const cUnderFunction & firstUnderfunction,
 ...
 * 	the new underfunction
 */
cFunctionSub::cFunctionSub( const cFunctionSub & underfunction,
		cUnderFunction * pInSuperiorFunction,
		cFibElement *pInDefiningFibElement ):
 ...
 * 	the new underfunction
 */
cFunctionSub::cFunctionSub( const TiXmlElement * pXmlElement, intFib & outStatus,
 ...
 * 	the new underfunction
 */
cFunctionSub::cFunctionSub( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
 ...
 * 	such exists
 */
doubleFib cFunctionSub::getValue() const{
 ...
 */
bool cFunctionSub::store( ostream & stream, char & cRestBits,
	...
	//store the identifier for the function sub
 ...
 */
unsignedIntFib cFunctionSub::getType() const{
 ...
 */
string cFunctionSub::getUnderFunctionName() const{
 ...
 */
cFunctionSub * cFunctionSub::clone(
		cUnderFunction * pInSuperiorUnderFunction,
		cFibElement *pInDefiningFibElement ) const{
	
	return new cFunctionSub( * this, pInSuperiorUnderFunction,
		pInDefiningFibElement );
}
