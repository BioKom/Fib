 ...
 * System: C++
 *
 * This class represents a Fib-function for the absolutvalue.
 ...
 *
 * This class represents a Fib-function for the absolutvalue.
 * This function realisises the absolutvalue of it's one underfunction.
 * ( abs( underfunction ) )
 *
 */
/*
 ...
 */
cFunctionAbs::cFunctionAbs( const cUnderFunction * const pUnderfunction,
 ...
 * 	the new underfunction
 */
cFunctionAbs::cFunctionAbs( const cFunctionAbs & underfunction,
		cUnderFunction * pInSuperiorFunction,
		cFibElement *pInDefiningFibElement ):
 ...
 * 	the new underfunction
 */
cFunctionAbs::cFunctionAbs( const TiXmlElement * pXmlElement, intFib & outStatus,
 ...
 * 	the new underfunction
 */
cFunctionAbs::cFunctionAbs( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
 ...
 * 	such exists
 */
doubleFib cFunctionAbs::getValue() const{
 ...
 */
bool cFunctionAbs::store( ostream & stream, char & cRestBits,
 ...
 */
unsignedIntFib cFunctionAbs::getType() const{
 ...
 */
string cFunctionAbs::getUnderFunctionName() const{
 ...
 */
cFunctionAbs * cFunctionAbs::clone(
		cUnderFunction * pInSuperiorUnderFunction,
		cFibElement *pInDefiningFibElement ) const{
	
	return new cFunctionAbs( * this, pInSuperiorUnderFunction,
		pInDefiningFibElement );
}
