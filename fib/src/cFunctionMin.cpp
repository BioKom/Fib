 ...
 * System: C++
 *
 * This class represents a Fib -function for the minimum evaluation.
 ...
 *
 * This class represents a Fib -function for the minimum evaluation.
 * This function realisises the minimum of it's two underfunctions.
 * ( min( underfunction1, underfunction2) )
 *
 */
/*
History:
 ...
 */
cFunctionMin::cFunctionMin( const cUnderFunction & firstUnderfunction,
 ...
 * 	the new underfunction
 */
cFunctionMin::cFunctionMin( const cFunctionMin & underfunction,
		cUnderFunction * pInSuperiorFunction,
		cFibElement *pInDefiningFibElement ):
 ...
 * 	the new underfunction
 */
cFunctionMin::cFunctionMin( const TiXmlElement * pXmlElement, intFib & outStatus,
 ...
 * 	the new underfunction
 */
cFunctionMin::cFunctionMin( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
 ...
 * 	such exists
 */
doubleFib cFunctionMin::getValue() const{
 ...
 */
bool cFunctionMin::store( ostream & stream, char & cRestBits,
	...
	//store the identifier for the function min
	char cInitiation = 0x17;
 ...
 */
unsignedIntFib cFunctionMin::getType() const{
 ...
 */
string cFunctionMin::getUnderFunctionName() const{
 ...
 */
cFunctionMin * cFunctionMin::clone(
		cUnderFunction * pInSuperiorUnderFunction,
		cFibElement *pInDefiningFibElement ) const{
	
	return new cFunctionMin( * this, pInSuperiorUnderFunction,
		pInDefiningFibElement );
}
