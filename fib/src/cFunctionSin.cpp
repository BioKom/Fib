 ...
 */
cFunctionSin::cFunctionSin( const cUnderFunction * const pUnderfunction,
 ...
 * 	the new underfunction
 */
cFunctionSin::cFunctionSin( const cFunctionSin & underfunction,
		cUnderFunction * pInSuperiorFunction,
		cFibElement *pInDefiningFibElement ):
 ...
 * 	the new underfunction
 */
cFunctionSin::cFunctionSin( const TiXmlElement * pXmlElement, intFib & outStatus,
 ...
 * 	the new underfunction
 */
cFunctionSin::cFunctionSin( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
 ...
 * 	such exists
 */
doubleFib cFunctionSin::getValue() const{
 ...
 */
bool cFunctionSin::store( ostream & stream, char & cRestBits,
	...
	//store the identifier for the function sin
	char cInitiation = 0x06;
 ...
 */
unsignedIntFib cFunctionSin::getType() const{
 ...
 */
string cFunctionSin::getUnderFunctionName() const{
 ...
 */
cFunctionSin * cFunctionSin::clone(
		cUnderFunction * pInSuperiorUnderFunction,
		cFibElement *pInDefiningFibElement ) const{
	
	return new cFunctionSin( * this, pInSuperiorUnderFunction,
		pInDefiningFibElement );
}
