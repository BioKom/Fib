 ...
 * System: C++
 *
 * This class represents a Fib -function for division.
 ...
 *
 * This class represents a Fib -function for division.
 * This function works on two underfunctions which values are divided.
 ...
 */
cFunctionDiv::cFunctionDiv( const cUnderFunction & firstUnderfunction,
 ...
 * 	the new underfunction
 */
cFunctionDiv::cFunctionDiv( const cFunctionDiv & underfunction,
		cUnderFunction * pInSuperiorFunction,
		cFibElement *pInDefiningFibElement ):
 ...
 * 	the new underfunction
 */
cFunctionDiv::cFunctionDiv( const TiXmlElement * pXmlElement, intFib & outStatus,
 ...
 * 	the new underfunction
 */
cFunctionDiv::cFunctionDiv( cReadBits & iBitStream, intFib & outStatus,
		list<cFibVariable*> & liDefinedVariables,
 ...
 * 	such exists
 */
doubleFib cFunctionDiv::getValue() const{
 ...
 */
bool cFunctionDiv::store( ostream & stream, char & cRestBits,
	...
	//store the identifier for the function div
	char cInitiation = 0x0F;
 ...
 */
unsignedIntFib cFunctionDiv::getType() const{
 ...
 */
string cFunctionDiv::getUnderFunctionName() const{
 ...
 */
cFunctionDiv * cFunctionDiv::clone(
		cUnderFunction * pInSuperiorUnderFunction,
		cFibElement *pInDefiningFibElement ) const{
	
	return new cFunctionDiv( * this, pInSuperiorUnderFunction,
		pInDefiningFibElement );
}
